...
public class DbSelectWrapper {
    ...
    public static void executeDbSelectHttpGet(String taskURL, Context context, View progressBar, View view, String applicationName, HttpApiSelectTask.AsyncResponseJSONArray asyncResponseJsonArray) {
    ...
    public static void executeDbSelectHttpGet(String taskURL, Context context, View progressBar, View view, String applicationName, HttpApiSelectTask.AsyncResponseJSONObject asyncResponseJsonObject) {
